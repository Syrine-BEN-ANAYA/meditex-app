...
const cards = [
  {
    title: "Texts & Content",
    desc: "Edit titles, descriptions and texts for each section of the site",
    href: "/admin/content",
  ...
  },
  {
    ...
    desc: "Manage the 6 collections of outfits, their titles and images",
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Manage your Muscat Meditex site content</p>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700 mt-1">
              The changes you make here are saved in the database and applied in real-time on the public site. Uploaded images replace the default images.
            </p>
          </div>
        </div>
      </div>
