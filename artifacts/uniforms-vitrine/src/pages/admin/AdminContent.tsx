...
const CONTENT_KEYS: Array<{ section: string; items: Array<{ key: string; label: string; multiline?: boolean }> }> = [
  {
    section: "Hero",
    items: [
      { key: "hero.title", label: "Titre principal" },
      { key: "hero.subtitle", label: "Sous-titre" },
      { key: "hero.description", label: "Description", multiline: true },
      { key: "hero.cta", label: "Bouton CTA" },
    ],
  },
  {
    section: "À propos",
  ...
  },
  {
    ...
    items: [{ key: "whyUs.title", label: "Titre" }],
  },
  {
    section: "Contact",
    items: [
  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Textes & Contenu</h1>
          <p className="text-gray-500 mt-1">Modifiez les textes du site en anglais et en arabe</p>
        </div>
