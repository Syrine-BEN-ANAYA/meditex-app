    ...
    <footer className="bg-primary text-primary-foreground pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="text-2xl font-bold">
              <div className="flex flex-col">
                <span className="tracking-widest uppercase">AL MAJD</span>
                <span className="font-arabic">مجد للزي الرسمي</span>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:info@almajduniforms.com" className="flex items-center gap-3 text-primary-foreground/70 hover:text-secondary transition-colors">
                <Mail className="w-5 h-5" />
                <span>info@almajduniforms.com</span>
              </a>
              <a href="https://instagram.com/almajduniforms" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-primary-foreground/70 hover:text-secondary transition-colors">
                <SiInstagram className="w-5 h-5" />
                <span>@almajduniforms</span>
              </a>
        ...
        <div className="border-t border-primary-foreground/10 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-primary-foreground/50">
          <p>&copy; {new Date().getFullYear()} Al Majd Uniforms. {content.en.footer.rights}</p>
          <p className="font-arabic mt-2 md:mt-0">&copy; {new Date().getFullYear()} مجد للزي الرسمي. {content.ar.footer.rights}</p>
        </div>
      </div>
    </footer>
  );
